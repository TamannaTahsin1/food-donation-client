  ...
  return (
    <div className="container mx-auto my-10" data-aos="fade-down-left">
      ...
      <p className="text-center text-sm text-gray-400">
        Donated foods provide essential sustenance to those in need, helping to{" "}
        <br /> alleviate hunger and promote food security.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {isShow
          ? features?.map((feature) => (
              <FeaturedFood key={feature._id} feature={feature}></FeaturedFood>
            ))
          : features
              ?.slice(0, 6)
              .map((feature) => (
